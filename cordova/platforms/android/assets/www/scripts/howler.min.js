...
!function () {
        ...
        for (var r in t._howls)
          if (t._howls.hasOwnProperty(r) && t._howls[r]._webAudio === !1)
            for (var i = 0; i < t._howls[r]._audioNode.length; i++)
              t._howls[r]._audioNode[i].volume = t._howls[r]._volume * t._volume;
        return t;
      }
  ...
  var l = function (e) {
    var t = this;
    t._autoplay = e.autoplay || !1, t._buffer = e.buffer || !1, t._duration = e.duration || 0, t._format = e.format || null, t._loop = e.loop || !1, t._loaded = !1, t._sprite = e.sprite || {}, t._src = e.src || '', t._pos3d = e.pos3d || [
      0,
      0,
      -0.5
    ], t._volume = e.volume || 1, t._urls = e.urls || [], t._rate = e.rate || 1, t._onload = [e.onload || function () {
      }], t._onloaderror = [e.onloaderror || function () {
      }], t._onend = [e.onend || function () {
      }], t._onpause = [e.onpause || function () {
      }], t._onplay = [e.onplay || function () {
      }], t._onendTimer = [], t._webAudio = n && !t._buffer, t._audioNode = [], t._webAudio && t._setupAudioNode(), u._howls.push(t), t.load();
  };
  if (l.prototype = {
      load: function () {
        var t = this, n = null;
        if (r)
          return t.on('loaderror'), void 0;
        for (var i = 0; i < t._urls.length; i++) {
          var s, o;
          if (t._format)
            s = t._format;
          else {
            if (o = t._urls[i].toLowerCase().split('?')[0], s = o.match(/.+\.([^?]+)(\?|$)/), s = s && s.length >= 2 ? s : o.match(/data\:audio\/([^?]+);/), !s)
              return t.on('loaderror'), void 0;
            s = s[1];
          }
          if (f[s]) {
      ...
      play: function (e, n) {
        ...
        return 'function' == typeof e && (n = e), e && 'function' != typeof e || (e = '_default'), r._loaded ? r._sprite[e] ? (r._inactiveNode(function (i) {
          i._sprite = e;
          var s, o = i._pos > 0 ? i._pos : r._sprite[e][0] / 1000, a = r._sprite[e][1] / 1000 - i._pos, f = !(!r._loop && !r._sprite[e][2]), l = 'string' == typeof n ? n : Math.round(Date.now() * Math.random()) + '';
          if (function () {
              var t = {
                  id: l,
                  sprite: e,
              ...
              }, 1000 * a), r._onendTimer.push(s), t.timer = r._onendTimer[r._onendTimer.length - 1];
            }(), r._webAudio) {
            var c = r._sprite[e][0] / 1000, h = r._sprite[e][1] / 1000;
            i.id = l, i.paused = !1, p(r, [
              f,
              c,
              h
            ], l), r._playStart = t.currentTime, i.gain.value = r._volume, void 0 === i.bufferSource.start ? i.bufferSource.noteGrainOn(0, o, a) : i.bufferSource.start(0, o, a);
          } else {
            if (4 !== i.readyState)
              return r._clearEndTimer(s), function () {
      ...
      pos: function (e, n) {
        ...
        if (i)
          return r._webAudio ? e >= 0 ? (i._pos = e, r.pause(n).play(i._sprite, n), r) : i._pos + (t.currentTime - r._playStart) : e >= 0 ? (i.currentTime = e, r) : i.currentTime;
        if (e >= 0)
          return r;
        for (var s = 0; s < r._audioNode.length; s++)
          if (r._audioNode[s].paused && 4 === r._audioNode[s].readyState)
            return r._webAudio ? r._audioNode[s]._pos : r._audioNode[s].currentTime;
      },
      pos3d: function (e, t, n, r) {
        var i = this;
        if (t = void 0 !== t && t ? t : 0, n = void 0 !== n && n ? n : -0.5, !i._loaded)
      ...
      fade: function (e, t, n, r, i) {
        var s = this, o = Math.abs(e - t), u = e > t ? 'down' : 'up', a = o / 0.01, f = n / a;
        if (!s._loaded)
        ...
        for (var l = 1; a >= l; l++)
          !function () {
            var e = s._volume + ('up' === u ? 0.01 : -0.01) * l, n = Math.round(1000 * e) / 1000, o = t;
            setTimeout(function () {
      ...
      _drainPool: function () {
        ...
        for (e = t._audioNode.length - 1; e >= 0 && !(5 >= n); e--)
          t._audioNode[e].paused && (t._webAudio && t._audioNode[e].disconnect(0), n--, t._audioNode.splice(e, 1));
      },
      _clearEndTimer: function (e) {
        var t = this, n = t._onendTimer.indexOf(e);
      ...
      unload: function () {
        for (var t = this, n = t._audioNode, r = 0; r < t._audioNode.length; r++)
          t.stop(n[r].id), t._webAudio ? n[r].disconnect(0) : n[r].src = '';
